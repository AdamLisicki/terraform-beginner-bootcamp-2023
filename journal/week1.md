...
We can use the `-var-file` flag to specify a variable definitiion file (.tfvars file).
...
Any files with names ending in .auto.tfvars or .auto.tfvars.json Terraform will load them automatically.
